...
public class GosDeviceListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//String deviceAlias = device.getDeviceName();
		String deviceAlias = "DC-400-01";
		//String devicePN = device.getMbattery();
		String devicebattay = "电量：1000";
		//holder.getTvDeviceMac().setText(device.getMacAddress());
		if (TextUtils.isEmpty(devicebattay)) {
			holder.getTvDeviceStatus().setText(devicebattay);
		} else {
			holder.getTvDeviceStatus().setText(devicebattay);
		}
