...
public class DevicebattayDataView extends View {


    private static final String TAG = "DevicebattayDataView";
    ...
    public DevicebattayDataView(Context context) {
        this(context, null);
    }

    public DevicebattayDataView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();//初始化方法
    }
    ...
    private void init() {
        ...
        mBarPaint = new Paint();
        mBarPaint.setColor(getResources().getColor(R.color.value_bule));
    ...
    private void drawBars(Canvas canvas) {
        ...
        for (int i = 0; i < mBars.size(); i++) {
            ...
            if (i == mSelectedIndex) {
                mBarPaint.setColor(getResources().getColor(R.color.tomato));
