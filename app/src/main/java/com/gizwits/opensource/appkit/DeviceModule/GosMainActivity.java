...
//	}
	...
	private void initTextView() {
		...
		t4 = (RelativeLayout) findViewById(R.id.linearLayout00);
		...
		tx4 = (TextView) findViewById(R.id.textview_login);
		tx5 = (TextView) findViewById(R.id.text4);
		tx6 = (TextView) findViewById(R.id.text5);
		tx7 = (TextView) findViewById(R.id.text6);
		tx8 = (TextView) findViewById(R.id.text7);
		tx9 = (TextView) findViewById(R.id.text8);
		tx10 = (TextView) findViewById(R.id.text9);

		img4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(GosMainActivity.this, DeviceOnlineLineChartActivity.class);
		...
		//t3.setOnClickListener(new MyOnClickListener(1));
	...
	private void initPagerViewer() {
		mViewpage = (FrameLayout) findViewById(R.id.viewpage);

		//final ArrayList<View> list = new ArrayList<View>();

		Intent intent = new Intent(context, GosDeviceListActivity.class);
//		intent.setAction("android.device.list");
		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		View pager = manager.startActivity("A",intent).getDecorView();
		mViewpage.removeAllViews();
		mViewpage.addView(pager);
