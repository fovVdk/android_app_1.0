...
public class DeviceOnlineLineChartView extends View {
    ...
    public DeviceOnlineLineChartView(Context context) {
        this(context, null);
    }

    public DeviceOnlineLineChartView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
