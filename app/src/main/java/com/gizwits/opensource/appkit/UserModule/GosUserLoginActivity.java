...
//		}
	...
	private void initView() {
		...
		etPsw = (EditText) findViewById(R.id.etPsw);//密码
		btnLogin = (Button) findViewById(R.id.btnLogin);//登陆按钮
		tvRegister = (TextView) findViewById(R.id.tvRegister);//注册
		tvForget = (TextView) findViewById(R.id.tvForget);//忘记
		tvPass = (TextView) findViewById(R.id.tvPass);//快速登陆
		cbLaws = (CheckBox) findViewById(R.id.cbLaws);//显示密码
...
//	}
	...
	private void initEvent() {
		btnLogin.setOnClickListener(this);//登陆监听
		tvRegister.setOnClickListener(this);//注册监听
		tvForget.setOnClickListener(this);//忘记密码监听
		tvPass.setOnClickListener(this);//快速登陆监听
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.tvPass:
				...
				intent = new Intent(GosUserLoginActivity.this, GosUserFastLoginActivity.class);
				startActivity(intent);
...
//		if(etName.getText().toString() == AssetsUtils.assetsDataToSD();)

//		if (GizWifiErrorCode.GIZ_SDK_SUCCESS != result) {// 登录失败
//			Toast.makeText(GosUserLoginActivity.this, toastError(result), toastTime).show();
		if(!etName.getText().toString().equals(GosDeploy.infoMap.get("user_name".toString()))) {
			Toast.makeText(GosUserLoginActivity.this, R.string.user_name_error, toastTime).show();


		} else if(!etPsw.getText().toString().equals(GosDeploy.infoMap.get("user_passwd".toString()))){
			Toast.makeText(GosUserLoginActivity.this, R.string.user_paswd_error, toastTime).show();
